...
namespace CSharpFundamentals
{
    public class DbCommand
    {
        ...
        public DbCommand(DbConnection dbConnection, string instruction)
        {
            ...
            {
                throw new Exception("You must provide a db connection");
            }
            else if (String.IsNullOrWhiteSpace(instruction))
            {
                throw new Exception("The connection must provide an instruction type");
            }
        ...
        public void Execute()
        {
            ...
            Console.WriteLine("Executing command: {0}", this.instruction);
        }
    }
