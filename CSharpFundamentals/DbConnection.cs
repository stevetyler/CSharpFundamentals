...
namespace CSharpFundamentals
{
    public abstract class DbConnection
    {
        ...
        public DbConnection(string connectionString)
        {
            ...
            if (String.IsNullOrWhiteSpace(connectionString))
                throw new Exception("You must provide a connection string");
        }
    ...
    public class SqlConnection : DbConnection
    {
        ...
        {
            Console.WriteLine("Opening SQL connection for {0}", connectionString);
        }

        public override void CloseConnection()
        {
            Console.WriteLine("Closing SQL connection for {0}", connectionString);
        }
    }
    ...
    public class OracleConnection : DbConnection
    {
        ...
        public override void OpenConnection()
        {
            Console.WriteLine("Opening Oracle connection for {0}", connectionString);
        }

        public override void CloseConnection()
        {
            Console.WriteLine("Closing Oracle connection {0}", connectionString);
        }
    }
}
